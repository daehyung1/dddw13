...
#define MAXGTRIDSIZE    8  	/* maximum size in bytes of gtrid */
#define MAXBQUALSIZE    4  	/* maximum size in bytes of bqual */

#define GTRID_LENGTH    8  /* GTRID_CONTROL_LENGTH + GTRID_DATA_LENGTH */
#define GTRID_CONTROL_LENGTH  4 
#define GTRID_DATA_LENGTH     4
#define BQUAL_LENGTH          4

struct xid32_t {		/* INFORMIX */
