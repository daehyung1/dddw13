...
private: 
	...
	typedef (*F_ISignDtop_IsLogin)();
	typedef (*F_ISignDtop_GetLastError)(ISIGNERROR *pErr);
	typedef (*F_ISignDtop_GetCurUserDN)(TCHAR *  pszDn, int nBufSize);
	typedef (*F_ISignDtop_GetCurUserPKICert)(char *pBuf, int *pLen, int nBufSize);
	typedef (*F_ISignDtop_GetCurUserID)(LPSTR pszID, int nBufSize);
